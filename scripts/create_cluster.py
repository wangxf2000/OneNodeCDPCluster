...
api_client = cm_client.ApiClient("http://localhost:7180/api/v43")
...
instargs = cm_client.ApiHostInstallArguments(
    ...
    user_name='root', 
    private_key=key, 
    cm_repo_url='https://archive.cloudera.com/cm7/7.3.1/', 
...
print("Starting to import Cluster template now...")
cmd = cm_api.import_cluster_template(add_repositories=True, body=dst_cluster_template)
wait(cmd)
print("Finished to import Cluster template now...")
